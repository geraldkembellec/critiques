...
?>
        ...
        <p>
        <label class="control-label col-sm-8" style="display: block; width: 450px;float: left;">Attribution <br />(laisser vide pour ne pas spécifier)</label>
        <select name="type">
            <option label="vide"></option>
        ...
        <p>
		<label class="control-label col-sm-8" style="display: block; width: 450px;float: left;">Type de signature <br />(laisser vide pour ne pas spécifier)</label>
        	<select name="typeSignature">
               <option label="vide"></option>
