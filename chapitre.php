...
<legend>Saisie d'un chapitre dans un ouvrage général</legend>        
                ...
                <p>Vous allez saisir un nouveau chapitre d'ouvrage ou une préface, postface, introduction dans un ouvrage
                    <label class="control-label col-sm-8">Rechercher le titre de l'ouvrage</label> ou <a onClick="nouvel_ouvrage();">proposer un ouvrage collectif</a>
