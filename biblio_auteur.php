<?php
	...
	echo "</h2>";
	echo "<h3>Ouvrages et ouvrages traduits</h3><ol>";
		listeCritiquesAuteurMonographies($_GET['critique'],$_GET['idcritiquesignee']);
	echo "</ol>";
	echo "<h3>Collaborations à des ouvrages collectifs</h3><ol>";
	...
	echo "</ol>";
	echo "<h3>Introductions, préfaces ou postfaces d'ouvrages</h3><ol>";
